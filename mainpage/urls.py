...
urlpatterns = [
    ...
    path(
        'rules/add',
        permission_required('mainpage.add_Rule')
        (views.RuleCreate.as_view()), 
        name='rules-add'
    ),
    path(
        'rules/<int:pk>/edit',
        permission_required('mainpage.change_Rule') 
        (views.RuleUpdate.as_view()), 
        name='rules-update'
    ),
    path(
        'rules/<int:pk>/delete',
        permission_required('mainpage.delete_Rule')
        (views.RuleDelete.as_view()), 
        name='rules-delete'
    ),
    path(
        'faq/',
